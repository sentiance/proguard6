...
public class ConfigurationParser
{
    ...
    throws ParseException, IOException
    {
        while (nextWord != null)
        {
            ...
            else if (ConfigurationConstants.KEEP_ORIGINAL_SOURCE_FILE_ATTRIBUTE_OPTION       .startsWith(nextWord)) configuration.keepOriginalSourceFileAttribute       = parseCommaSeparatedList("class name", true, true, false, false, true, false, false, true, false, configuration.keepOriginalSourceFileAttribute);
